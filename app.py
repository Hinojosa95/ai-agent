...
def voice():
    ...
    try:
        idioma = detect(speech_result) if speech_result else "en"
    except LangDetectException:
        idioma = "en"

    # Datos del cliente si no existen
    ...
    pasos = [
        ("intro", f"""Hi {rep_name}, this is Bryan. I help truckers save up to $500 per month per truck on insurance,
...
Do you have 2 minutes for a quick quote? Let's get started. What year, make and model is your truck?"""
        if data['lang'] == 'en' else
        f"""Hola {rep_name}, soy Bryan. Ayudo a camioneros a ahorrar hasta $500 al mes por camión en seguros,
...
¿Tienes 2 minutos para una cotización rápida? Empecemos: ¿Cuál es el año, marca y modelo de tu camión?"""),
    ...
    # Guardar respuesta anterior si aplica
