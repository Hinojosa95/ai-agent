...
for lead in leads:
    ...
    print(f"☎️ Procesando lead: {rep_name_raw} - {phone}")

    try:
        call = client.calls.create(
            url=f"https://ai-agent-01hn.onrender.com/voice?rep={rep_name_encoded}",
            to=phone,
...
print(f"📋 Reporte diario guardado en {filename}")